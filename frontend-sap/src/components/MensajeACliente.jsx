...
const CLIENTES_API_URL = process.env.REACT_APP_SOLOCLIENTE

function MensajeACliente() {
  ...
  return (
    <>
    <div>
    <h2 style={{textAlign: "center", marginTop: "20px"}}>Sistema de Mensajeria A Clientes</h2>
...
export default MensajeACliente;