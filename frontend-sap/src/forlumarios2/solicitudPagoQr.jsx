  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const boletasPendientes = boletasWithNames.filter(boleta => boleta.estado === 4);
        const boletasAceptadas = boletasWithNames.filter(boleta => boleta.estado === 5);
        const boletasRechazadas = boletasWithNames.filter(boleta => boleta.estado === 6);
...
export default SolicitudPagoQr;